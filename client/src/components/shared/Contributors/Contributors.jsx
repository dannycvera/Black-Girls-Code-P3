	...
	return (
		<div className="contributor-container">
			...
			<h2 className="girl-quotes">
				"The Hackathon was so much <span className="quote-span">FUN!</span>"
			</h2>
			<h2 className="girl-quotes">
				"I <span className="quote-span">CAN'T WAIT</span> to do this again next
				year!"
			</h2>
			<NavLink to="/donations">
				<Button content="DONATE" sizeClassName="large-donate" />
			</NavLink>
		</div>
	)
}
