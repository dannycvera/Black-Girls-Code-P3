			...
			<div className="home">
				...
				<div className="home-content">
					<p className="vision">
						...
						builders of their own futures through exposure to computer science
						and technology. To provide African-American youth with the skills to
					...
					<div className="students_div">
						...
						<p className="student_text">
							...
							is just beginning! STEM from home with Black Girls CODE this
							summer. Our #CodeTheSummer virtual camps are here to give your
							tech geniuses the opportunity to learn all about video game
							design, iOS app development, and robotics. Camp officially begins
							on July 6 with a session for boys AND girls ages 7-9. Sessions for
							older students to be announced soon.{" "}
						</p>
						<a
					...
					<div className="floating_div">
						<div className="left_content">
							...
							<p className="office_text">
								...
								mission-aligned team of folks striving to change the world take
								a look at our careers page. <br />
						...
						<div className="right_text">
							...
							<p className="description">
								When we give girls of color the tools to develop their own
								future, great things are bound to happen. BGC founder Kimberly
								Bryant can definitely relate.{" "}
								<a
							...
							<p className="description">
								...
								eagerly jumped into programming. Have a look at what we've done
								to support girls in STEM and{" "}
								<a
									href="https://www.blackgirlscode.com/programsevents.html"
									target="_blank"
								>
							...
							<p className="description">
								...
								<a href="https://www.blackgirlscode.com/blog" target="_blank">
									<span className="pink-text">blog</span>
								</a>
								.
							</p>
							<p className="description">
							...
							<p className="description">
								Do you code? Are you an organizer? Photographer? Just want to
								help out as we grow and expand to new cities? Sign up to
								volunteer{" "}
								<a
							...
							<p className="description">
								Want to help us change the world? Join a local core team! See
								the core team roles,descriptions, and application{" "}
								<a
